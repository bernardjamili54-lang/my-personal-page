...
<li>gradute senioor high school with honors</li><li>get a scholarship for college</li><li>learn programming and web developer</li>
    ...
    <section aria-labelledby="goals">
      ...
      <p><strong>Career goal:</strong> I want to become a <strong>Software Engineer</strong> someday. I hope to build websites and apps that make people’s lives easier.</p>
    </section>
  </main>

  <footer>
    <hr>
    <p><small>This webpage was created for my HTML class, 2026.</small></p>
  </footer>
</body>
</html>
